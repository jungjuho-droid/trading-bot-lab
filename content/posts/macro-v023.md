---
title: "[개발일지] MACRO.V023 — 세이브 포인트"
description: "MACRO.V023 · A Save Point"
date: 2026-07-10T09:19:00+09:00
draft: false
series: ["병렬 실험기"]
tags: ["개발일지", "병렬실험기", "자동매매", "업비트", "Trading Bot Lab"]
summary: "세이브 포인트. 병렬 실험기 63/108."
---

## 배경

이 글은 MACRO 실험기의 한 페이지, MACRO.V023 의 기록이다. 거시 신호를 진입 필터로 쓰려던 60여 개 버전의 실험 계열이다. 이 시리즈에 보존된 57개 버전 가운데 16번째 기록이다. 게시일은 버전 순서 기준 추정 배정이다 (원본 시각 소실).

<div class="term">
<div class="term-bar"><i></i><i></i><i></i><em>MACRO023.py — 673줄</em></div>
...
코드는 673줄. 직전 버전 대비 +0/-0줄 — 미세 조정이다. 파일 머리의 당시 메모: "======================================================================". 커밋이 없던 시절이라 의도는 diff 로만 남았다. 이번 보존본의 무게중심은 **세이브 포인트**이다.
