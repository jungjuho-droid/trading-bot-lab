...
- **ASI** (Accumulative Swing Index): 누적 스윙 지수. 웰스 와일더의 스윙 지수(SI)를 하루씩 누적한 선. 시가·고가·저가·종가의 관계로 실질 추세를 읽는다.
- **SI** (Swing Index): 스윙 지수. 당일과 전일의 시가·고가·저가·종가를 비교해 하루의 방향과 강도를 하나의 수로 만든 것.
